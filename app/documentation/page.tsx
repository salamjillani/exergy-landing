      ...
      <nav className="fixed top-0 w-full z-50 bg-black/95 backdrop-blur-sm border-b border-zinc-800/50">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between px-8 py-5">
          ...
          <div className="hidden lg:flex items-center space-x-10 text-[15px] font-medium">
            ...
            <a href="/documentation" className="text-white hover:text-white transition-colors">Documentation</a>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={5}
                  className="w-full px-4 py-3 border text-zinc-900 border-zinc-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none"
